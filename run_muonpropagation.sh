...
pyfile=/home/users/bdillon/P-ONE/sim0001/src/GenerateEvents_MuonGun.py
...
for i in $(seq 0 1 10)
do
	./submit_job.sh bash $envs python $pyfile -g $gcd -o $outfile/GenerateSingleMuons_$i.i3.gz -n 10 -r $i
done
