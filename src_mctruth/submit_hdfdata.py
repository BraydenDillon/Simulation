...
opts = {}
opts["out"] = '/home/users/bdillon/P-ONE/sim0002/src_mctruth'
opts["data"] = '/home/users/bdillon/P-ONE/sim0002/reco_mctruth/selection'
...
'''.format(opts["job"],
           ...
           opts["out"]+"/70_string_muon_gun_reco_mctruth_sim0002.hdf5")
