...
opts = {}
opts["out"] = '/home/users/bdillon/P-ONE/sim0002/reco_mctruth'
opts["data"] = '/home/users/bdillon/P-ONE/sim0002/linefit'
opts["job"] = '/home/users/bdillon/P-ONE/sim0002/src_mctruth'
opts["gcd"] = '/home/users/bdillon/P-ONE/sim0002/gcdfile'

processfilename = 'run_mctruth'
submissionfilename = 'run_mctruth.submit'

job_string = '''#!/bin/bash

eval `/cvmfs/icecube.opensciencegrid.org/py3-v4.1.1/setup.sh`

bash /data/p-one/twagiray/trackreco/mmsreco_convs/env-shell.sh python {}/mmsreco_spline_mctruth.py -i {} -o {} -r $1 -g {}
